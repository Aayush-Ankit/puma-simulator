...
dataMem_size = 2048 #131072 # 2048 is larger than num_matrix*(6*xbar_size)
instrnMem_size = 512 #262144 #in entries
...
num_ima = 8
edram_size = 64 #8192 # in Kilobytes (64 KB - same as issac)
tile_instrnMem_size = 2048 #262144 # in entries
