...
dict_temp = {}
dict_list = []
i_temp = i_set(d1=257, imm=20, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=257, r1=257, load_width=10, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=267, imm=858, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=0, r1=267, load_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=267, imm=986, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=267, imm=1114, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=267, imm=30, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_store(d1=267, r1=257, counter=1, store_width=10, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'mlpRtttt/tile2/core_imem3.npy'
