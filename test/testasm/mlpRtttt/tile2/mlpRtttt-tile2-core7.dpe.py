...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=277, imm=1892, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=0, r1=277, load_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=277, imm=2020, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=277, imm=2148, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=277, imm=70, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_store(d1=277, r1=257, counter=1, store_width=10, vec=2)
dict_list.append(i_temp.copy())
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'mlpRtttt/tile2/core_imem7.npy'
