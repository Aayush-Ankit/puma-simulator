...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=641, imm=2880, vec=1)
dict_list.append(i_temp.copy())
...
i_temp = i_mvm(['10'])
dict_list.append(i_temp.copy())
i_temp = i_alu('add', d1=513, r1=513, r2=256, vec=104)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=617, imm=2048, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_store(d1=617, r1=513, counter=1, store_width=13, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'vgg16/tile472/core_imem0.npy'
