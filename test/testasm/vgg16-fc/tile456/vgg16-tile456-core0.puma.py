...
dict_list.append(i_temp.copy())
i_temp = i_store(d1=641, r1=513, counter=31, store_width=16, vec=8)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_store(d1=769, r1=641, counter=31, store_width=16, vec=8)
dict_list.append(i_temp.copy())
...
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'vgg16/tile456/core_imem0.npy'
