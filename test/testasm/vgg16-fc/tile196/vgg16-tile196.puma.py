...
dict_list.append(i_temp.copy())
i_temp = i_receive(mem_addr=3072, vtile_id=195, receive_width=16, counter=1, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_send(mem_addr=896, vtile_id=196, send_width=16, target_addr=197, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_halt()
dict_list.append(i_temp.copy())
filename = 'vgg16/tile196/tile_imem.npy'
