...
dict_list.append(i_temp.copy())
i_temp = i_receive(mem_addr=3072, vtile_id=146, receive_width=16, counter=1, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_send(mem_addr=896, vtile_id=147, send_width=16, target_addr=148, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_halt()
dict_list.append(i_temp.copy())
filename = 'vgg16/tile147/tile_imem.npy'
