...
dict_temp = {}
dict_list = []
i_temp = i_set(d1=513, imm=798, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_load(d1=513, r1=513, load_width=16, vec=8)
dict_list.append(i_temp.copy())
i_temp = i_set(d1=641, imm=926, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=533, imm=20, vec=1)
dict_list.append(i_temp.copy())
...
dict_list.append(i_temp.copy())
i_temp = i_set(d1=523, imm=1054, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_store(d1=523, r1=513, counter=1, store_width=10, vec=1)
dict_list.append(i_temp.copy())
i_temp = i_hlt()
dict_list.append(i_temp.copy())
filename = 'mlp/tile22/core_imem3.npy'
