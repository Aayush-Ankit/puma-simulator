...
class DPE:
    ...
    def run(self, net):
        ...
        if cfg.authenticated:
            modelcheck(instrndir)
        if cfg.encrypted:
            olddir=instrndir
            oldpath=instrndir+"/"
            decrypt(instrndir+'/crypto')
            instrndir=instrndir+"/crypto/decrypted"
        ...
        if cfg.encrypted:
            inp_filename = oldpath + 'input.npy'
        else:
        ...
        if cfg.authenticated:
            check(inp_filename,instrndir+"/"+'signature.txt')
