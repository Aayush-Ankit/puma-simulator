...
if __name__ == '__main__':
    ...
    parser.add_argument(
            "-t", "--tile", help ="The number of tiles as generated by compiler.", default=7)
    args = parser.parse_args()
    net = args.net
    # FIXME Assigning cfg.num_tile_compute after the 'import' does not change
    # it for all the modules that had already read the file. Most modules will
    # still keep the value from the file. Need to find another way to change
    # that in runtime.
    # cfg.num_tile_compute = int(args.tile)
